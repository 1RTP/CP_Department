...
namespace Demo
{
    public partial class Form1 : BaseForm
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            // Uncomment to use FastScript C# compiler by default.
            // Warning: no VB.NET support, no dynamic support (some Advanced Matrix reports will fail)
            //FastReport.Code.CodeProvider.DefaultProvider = typeof(FastReport.Code.FastScript.FastScriptCodeProvider);

            // Uncomment to use old-style RibbonUI
            //Config.UseOldRibbon = true;
